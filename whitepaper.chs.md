...
本平台致力于打造一套如下的系统：
## 支持亿级的用户数
像BAT，或者是Google, Amazon这样的巨无霸级的系统，需要为上亿的用户提供稳健的系统支撑。
考虑到麦特卡夫定律，本系统的价值与用户数的平方成正比，因此，随着时间的发展，系统必将具备很强的延续性。
## 并行计算
无论是单机的多线程、多核CPU，还是基于网络的高并发，系统需要提供一种分派任务的机制
## 低延迟
低延迟是良好用户体验的最关键因素。
## 良好的升级与错误修复
“凡是代码，都会有bug”。因而，系统的升级也是很必要的一环。


# 特性
## 基于DPOS(授权的股权证明机制)的增量
