...
## 石墨烯
“石墨烯”（graphene）是一套区块链工具。它由比特股团队cryptonomex开发，采用C++编写。“石墨烯”主要的优势是并发能力强。基于“石墨烯”的BTS和STEEM可以使平均单笔交易速度缩短至1.5秒，以及在硬件资源受限的条件下实测每秒3300笔交易的数据吞吐量。更进一步，EOS通过并行链的方式可以达到更高的性能指标。
