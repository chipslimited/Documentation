...
# 导语
我们阅读了海量的区块链项目白皮书。在架构选型时，我们大量学习了ETH与EOS的构建方式，并在其白皮书中对其技术特性进行了深入挖掘。最终，CHIPS创始团队成员一致认为ETH与EOS的技术特性高度符合《CPS商业白皮书》。

我们分别模拟了ETH与EOS的主链运行机制，以下将重点从技术角度对CPS代码潜力进行一一阐述，并在《CPS商业白皮书》中对挖掘到的技术逻辑点进行对应的商业延伸介绍，用以高度配合CHIPS生态系统2.0版本既数字王国的建立。我们将围绕ETH与EOS主网进行一系列的相关生态搭建。
...
## 热钱包
之所以推出热钱包，是为了能够更好地提升用户体验。普通用户，尤其是那些初次接触区块链的用户，比较熟悉传统的中心化的账号及余额管理体系。他们一方面不熟悉“私钥”，但比较熟悉传统的中心化的账号及余额管理体系。虽然本系统在区块链层面上已经提供了一套账户管理系统，但是用户可能同时需要一个“传统的”web方式的钱包。对于初阶用户，这样一个热钱包够用了。对于高阶用户，他们除了需要一个冷钱包确保安全以外，也需要一个便利的热钱包，以供日常小额转账支付使用。
